...
urlpatterns = [
    ...
    path('add_staff',Hodviews.CreateStaffView.as_view(),name='add_staff'),
    path('add_course',Hodviews.CreateCourseView.as_view(),name='add_course'),
    
    path('add_student',Hodviews.AddStudent,name='add_student'),
    path('add_subject',Hodviews.CreateSubjectView.as_view() ,name='add_subject'),
